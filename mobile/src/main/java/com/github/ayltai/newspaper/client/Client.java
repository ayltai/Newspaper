...
public abstract class Client {
    ...
    protected final NewsApiService apiService;
    protected final Source       source;

    //endregion

    protected Client(@NonNull final OkHttpClient client, @NonNull final NewsApiService apiService, @NonNull final Source source) {
        this.client     = client;
