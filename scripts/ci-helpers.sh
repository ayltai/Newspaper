...
function generateTestReports() {
    ...
    cp -r app/build/test-results/testDebugUnitTest/*.xml $CIRCLE_TEST_REPORTS && cp -r app/build/reports/tests/testDebugUnitTest $CIRCLE_TEST_REPORTS && cp -r app/build/reports/jacoco/jacocoReport $CIRCLE_TEST_REPORTS
}
