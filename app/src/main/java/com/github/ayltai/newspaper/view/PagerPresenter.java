...
public final class PagerPresenter extends BasePresenter<PagerPresenter.View> {
    ...
    @CallSuper
    @Override
    public void onViewAttached(@Nonnull @NonNull @lombok.NonNull final PagerPresenter.View view, final boolean isFirstAttachment) {
